...
public class GPSDataConverter {
	...
	public static int toSeconds(String timestr) {
        ...
        String aarstalBort = parts[1];
        String[] aarstalBortOgZBort = aarstalBort.split(".000");
        String fullTid = aarstalBortOgZBort[0];
        String[] tider = fullTid.split(":");
        hr = Integer.parseInt(tider[0]);
        min = Integer.parseInt(tider[1]);
        sec = Integer.parseInt(tider[2]);
